...
def add_products(products, categories, subcategories):
    ...
    for product in products:
        category_id = categories.get(product["category"], 1)
        ...
        product_dict["product"]["avaliable_for_order"] = 1
...
add_products(products, categories_assigned,subcategories_assigned)
